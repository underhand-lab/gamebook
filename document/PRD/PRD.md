...
- 핵심 경험: 경기 검색, 태그 탐색, 일자별 경기 모아보기, 관람 기록, 리뷰 작성, 팬 관점별 커뮤니티 확인, Calendar / Diary, 프로필 회고.
- MVP 범위: 회원가입, 프로필, 경기 검색, 경기 상세, 태그 검색, 일자별 경기, Calendar / Diary, 리뷰, 평점, 별점 분포, 태그, 좋아요, 경기 MVP, 관람 방식, 팬 관점, 통계, 리그별 다중 응원팀 관리.
